# The name of this view in Looker is "Instacart Order Products Master Copy"
view: instacart_order_products_master_copy {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `atlan_trial.INSTACART_ORDER_PRODUCTS_MASTER_copy`
    ;;
