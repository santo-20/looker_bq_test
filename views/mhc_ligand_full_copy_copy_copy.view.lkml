# The name of this view in Looker is "Mhc Ligand Full Copy Copy Copy"
view: mhc_ligand_full_copy_copy_copy {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `atlan_trial.mhc_ligand_full_copy_copy_copy`
    ;;
