# The name of this view in Looker is "Instacart Snacks Order Time Copy Copy Copy"
view: instacart_snacks_order_time_copy_copy_copy {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `atlan_trial.INSTACART_SNACKS_ORDER_TIME_copy_copy_copy`
    ;;
