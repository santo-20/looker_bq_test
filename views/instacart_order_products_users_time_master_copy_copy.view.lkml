# The name of this view in Looker is "Instacart Order Products Users Time Master Copy Copy"
view: instacart_order_products_users_time_master_copy_copy {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `atlan_trial.INSTACART_ORDER_PRODUCTS_USERS_TIME_MASTER_copy_copy`
    ;;
