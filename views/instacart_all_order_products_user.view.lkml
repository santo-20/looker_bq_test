# The name of this view in Looker is "Instacart All Order Products User"
view: instacart_all_order_products_user {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `atlan_trial.INSTACART_ALL_ORDER_PRODUCTS_USER`
    ;;
