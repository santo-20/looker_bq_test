# The name of this view in Looker is "Instacart Top Beverage Users Orders"
view: instacart_top_beverage_users_orders {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `atlan_trial.INSTACART_TOP_BEVERAGE_USERS_ORDERS`
    ;;
