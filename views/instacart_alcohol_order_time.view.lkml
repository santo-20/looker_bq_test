# The name of this view in Looker is "Instacart Alcohol Order Time"
view: instacart_alcohol_order_time {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `atlan_trial.INSTACART_ALCOHOL_ORDER_TIME`
    ;;
