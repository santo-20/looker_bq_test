# The name of this view in Looker is "Instacart Bakery Order Time Copy"
view: instacart_bakery_order_time_copy {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `atlan_trial.INSTACART_BAKERY_ORDER_TIME_copy`
    ;;
