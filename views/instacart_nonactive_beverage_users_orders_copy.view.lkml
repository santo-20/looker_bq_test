# The name of this view in Looker is "Instacart Nonactive Beverage Users Orders Copy"
view: instacart_nonactive_beverage_users_orders_copy {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `atlan_trial.INSTACART_NONACTIVE_BEVERAGE_USERS_ORDERS_copy`
    ;;
